...
public class RA_Activity1 {
	@Test(priority = 1)
	public void addNewPet() {
		Map<String, Object> reqBody = new HashMap<>();
		reqBody.put("id", 54321);
		reqBody.put("name", "Rubee");
		...
		response.then().body("name", equalTo("Rubee"));
	...
	public void getPetInfo() {
		Response response = given()
			.baseUri("https://petstore.swagger.io/v2/pet") // Set base URI
			.header("Content-Type", "application/json") // Set headers
			.when().pathParam("petId", 54321) // Set path parameter
	...
	public void deletePet() {
		...
		response.then().body("message", equalTo("54321"));
	}
}